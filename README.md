...
3. install pyqt5 (https://pypi.org/project/PyQt5) with comand: pip install pyqt5
4. install the package with the cmd: pip install .
5. once through the installation, use one of the entrypoints to launch one app: ccg --help
