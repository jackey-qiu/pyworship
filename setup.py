...
setup(
    ...
    license = 'MIT',
    install_requires = ['PyQt5', 'pyqtgraph', 'qpageview', 'pyqtchart', 'qdarkstyle', 'numpy', 'pymongo', 'bcrypt','python-dotenv', 'pandas', 'dnspython', 'click', 'python-pptx', 'python-docx', 'jieba', 'whoosh','yt-dlp','pyyaml', 'pypinyin'],
